...
class GetPriceCollection extends \Datenkraft\Backbone\Client\PriceAssessmentApi\Generated\Runtime\Client\BaseEndpoint implements \Datenkraft\Backbone\Client\PriceAssessmentApi\Generated\Runtime\Client\Endpoint
{
    ...
    */
    ...
    protected function getQueryOptionsResolver(): \Symfony\Component\OptionsResolver\OptionsResolver
    {
        ...
        $optionsResolver->setDefined(['page', 'pageSize', 'paginationMode', 'filter[customerId]', 'filter[skuCode]', 'filter[validFrom]']);
        $optionsResolver->setRequired(['filter[customerId]', 'filter[skuCode]']);
        ...
        $optionsResolver->addAllowedTypes('filter[customerId]', ['string']);
