...
class CustomerPricingProfileCollection extends \ArrayObject
{
    /**
     * @var array
     */
    ...
    /**
     * @var list<CustomerPricingProfile>
     */
    protected $data;
    /**
    ...
    /**
     * @return list<CustomerPricingProfile>
     */
    ...
    /**
     * @param list<CustomerPricingProfile> $data
     *
     * @return self
     */
